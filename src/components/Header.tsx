    ...
    <div className="bg-[#a2d0d3] h-screen  w-full">
      <div className="top-0  w-full z-10 flex justify-between items-center p-5  max-w-7xl mx-auto bg-transparent overflow-hidden">
        <motion.div
          ...
          ref={constraintsRef}
        >
          {socials?.map((platform: Social) => (
            <motion.div
              key={platform?._id}
              className="font-[475] text-white text-xl w-fit cursor-pointer flex justify-between mx-4"
              // style={{
              //   width: "fit-content",
              //   fontSize: 50,
              // }}
        ...
        >
          ...
          <h1 className="font-[450] text-white text-xl mx-2 cursor-pointer">
            Code by Hrishi
          </h1>
        </motion.div>
        <motion.div
